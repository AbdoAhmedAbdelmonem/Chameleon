let question = [
     {
        ...
        options: ["A) First-In-First-Out (FIFO)", "B) Last-In-First-Out (LIFO)", "C) Random Access", "D) Priority-Based"],
    ...
    },
    {
        ...
        options: ["A) pop()", "B) push()", "C) peek()", "D) dequeue()"],
        answer: "B) push()"
    },
    {
        numb: 3,
    ...
    },
    {
        numb: 10,
        type: "Multiple Choices",
        question: "Which operation is used to remove an element from the front of a queue?",
        options: ["A) push()", "B) pop()", "C) enqueue()", "D) dequeue()"],
        answer: "D) dequeue()"
    },
    {
    ...
    },
    {
        numb: 13,
        type: "Multiple Choices",
        question: "What is the primary characteristic of a priority queue?",
        options: ["A) First-In-First-Out (FIFO)", "B) Last-In-First-Out (LIFO)", "C) Random Access", "D) Priority-Based"],
        answer: "D) Priority-Based"
    },
    {
        numb: 14,
        type: "Multiple Choices",
    ...
    },
    {
        ...
        options: ["A) Function call stack", "B) Undo operation in text editors", "C) CPU scheduling", "D) Expression evaluation"],
    ...
    },
    {
        ...
        options: ["A) Printer queue", "B) Breadth-First Search (BFS)", "C) Expression evaluation", "D) Task scheduling"],
        answer: "C) Expression evaluation"
    },
    {
        numb: 19,
        type: "Multiple Choices",
        question: "Which of the following is NOT a valid application of a priority queue?",
        options: ["A) Dijkstra's algorithm", "B) Huffman coding", "C) CPU scheduling", "D) Undo operation in text editors"],
        answer: "D) Undo operation in text editors"
    },
    {
        numb: 20,
        type: "Multiple Choices",
        question: "In a stack, if you push the elements 1, 2, 3, 4 in order, what will be the order of popping them?",
        options: ["A) 1, 2, 3, 4", "B) 4, 3, 2, 1", "C) 1, 3, 2, 4", "D) 4, 2, 3, 1"],
        answer: "B) 4, 3, 2, 1"
    },
    {
        numb: 21,
        type: "Multiple Choices",
        question: "In a queue, if you enqueue the elements 1, 2, 3, 4 in order, what will be the order of dequeuing them?",
        options: ["A) 1, 2, 3, 4", "B) 4, 3, 2, 1", "C) 1, 3, 2, 4", "D) 4, 2, 3, 1"],
        answer: "A) 1, 2, 3, 4"
    },
    {
        ...
        options: ["A) 9", "B) 10", "C) 11", "D) Unlimited"],
        answer: "B) 10"
    },
    {
        numb: 23,
        type: "Multiple Choices",
        question: "What is the maximum number of elements that can be stored in a queue of size 10?",
        options: ["A) 9", "B) 10", "C) 11", "D) Unlimited"],
        answer: "B) 10"
    },
    {
        ...
        options: ["A) It uses a fixed-size array", "B) It allows wrapping around the end of the array", "C) It is more efficient than a linear queue", "D) All of the above"],
    ...
    },
    {
        ...
        options: ["A) Faster enqueue operation", "B) Faster dequeue operation", "C) Elements are processed based on priority", "D) Elements are processed in FIFO order"],
        answer: "C) Elements are processed based on priority"
    },
    {
        numb: 26,
        type: "Multiple Choices",
        question: "Which of the following is true about a double-ended queue (deque)?",
        options: ["A) Elements can be added or removed from both ends", "B) It follows FIFO principle", "C) It follows LIFO principle", "D) It is implemented using a stack"],
        answer: "A) Elements can be added or removed from both ends"
    },
    {
        numb: 27,
        type: "Multiple Choices",
    ...
    },
    {
        numb: 29,
        type: "Multiple Choices",
        question: "What is the time complexity of searching for an element in a priority queue implemented with a binary heap?",
        options: ["A) O(1)", "B) O(log n)", "C) O(n)", "D) O(n^2)"],
        answer: "C) O(n)"
    },
    {
        ...
        options: ["A) The smallest element is at the root", "B) The largest element is at the root", "C) It is used to implement a stack", "D) It is used to implement a queue"],
