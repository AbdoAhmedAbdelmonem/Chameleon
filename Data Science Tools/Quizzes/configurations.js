...
function showImagePopup(index, button) {
    ...
    if (window.matchMedia("(max-width: 768px)").matches) {
        ...
        // Desktop styles - larger popup
        popup.style.width = '80%';
        popup.style.maxWidth = '1200px'; // Larger max width for big screens
    }

    // Image container with improved responsive behavior
    ...
    imageContainer.style.maxHeight = '85vh'; // Ensure it fits within viewport
    ...
    // Set different max sizes based on device
    ...
    // Zoom functionality (same as before)
    let currentScale = 1;
    ...
    // Mouse drag to pan (same as before)
